...
هەروەها لەوانەیە کووکی دروست بکەین لە دەرەوەی نەرمەکاڵای phpBB لە کاتی گەڕان بە ناو “%1$s”، سەرەڕای ئەوەش ئەمە لە دەرەوەی بینینی ئەم بەڵگەنامەیەیە کە وا چاوەڕوان دەکرا تەنها ئەو پەڕانە دابپۆشێت کە لە لایەن نەرمەكاڵای phpBB ـیەوە دروست کراون.',
	...
	'FIELD_TOO_LONG'					=> array(
		1	=> 'خانەی “%1$s” زۆر درێژە، لانی زۆر %2$d نووسە ڕێ پێدراوە.',
		2	=> 'خانەی “%1$s” زۆر درێژە، لانی زۆر %2$d نووسە ڕێ پێدراوە.',
	),
	'FIELD_TOO_SMALL'					=> 'نرخی “%1$s” زۆر بچوکە، لانی کەم نرخی %2$d پێویستە.',
	'FIELD_TOO_LARGE'					=> 'نرخی “%1$s” زۆر گەورەیە، لانی کەم نرخی %2$d پێویستە.',
	'FIELD_INVALID_CHARS_INVALID'		=> 'خانەی “%s” کارەکەتەری هەلەی تێدایە.',
	'FIELD_INVALID_CHARS_NUMBERS_ONLY'	=> 'خانەی “%s” نووسەی نەگونجاوی تیادایە، تەنها ژمارە ڕێ پێدراوە.',
	'FIELD_INVALID_CHARS_ALPHA_DOTS'	=> 'خانەی “%s” کارەکتەری هەلەی لەخۆ گرتووە, تەنها alphanumeric یان . characters ڕێ پێدراو.',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'خانەی “%s” نووسەی نەگونجاوی تیادایە، تەنها پیتی ئەلفا و ژمارە ڕێ پێدراوە.',
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'خانەی “%s” کارەکتەری هەلەی لەخۆ گرتووە, تەنها alphanumeric یان _,-. characters ڕێ پێدراون یەکەم کارەکتەر پێویستە  alphabetic بێت.',
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'خانەی “%s” کارەکتەری هەلەی لەخۆ گرتووە, تەنها alphanumeric, space یان -+_[] characters ڕێ پێ دروان.',
	'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'خانەی “%s” کارەکتەری هەلەی لەخۆ گرتووە, تەنها alphanumeric یان _ characters ڕێ پێدراون.',
	'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'خانەی “%s” کارەکتەری هەلەی لەخۆ گرتووە, تەنها پیت, number یان . characters ڕێ پێدراون.',
	'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'	=> 'خانەی “%s” کارەکتەری هەلەی لە خۆ گرتووە, تەنها پیت و ژمارە  ڕێ پێدراون.',
	'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'	=> 'خانەی “%s” کارەکتەری هەلەی لەخۆ گرتووە, تەنها پیت, ژمارە یان _,-. characters ڕێ پێدراون  هەروەها یەکەم کارەکتەر پێویستە alphabetic بێت.',
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'		=> 'خانەی “%s”کارەکتەری هەلەی لەخۆ گرتووە, تەنها پیت, ژمارە, space یان -+_[] کارەکتەر ڕێ پێ دراوە.',
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'خانەی “%s” کارەکتەری هەلەی لەخۆ گرتووە, تەنها پیت, ژمارە یان _ ئەو کارەکتەرانەی ڕێ پێ دروان.',
	'FIELD_INVALID_DATE'				=> 'خانەی “%s” دراوەی نەگونجاوی تیادایە.',
	'FIELD_INVALID_URL'					=> 'خانەی “%s” بەستەرێکی هەلەی لەخۆ گرتووە.',
	'FIELD_INVALID_VALUE'				=> 'خانەی “%s” نرخێکی هەلەی لەخۆ گرتووە.',

	'FOE_MESSAGE'				=> 'پەیام لە فەرامۆشکراوەوە',
	'FOES_EXPLAIN'				=> 'فەرامۆشکراوان ئەو بەکارهێنەرانەن کە بە شێوەیەکی بنەڕەت فەرامۆش دەکرێن. پەیامەکانی ئەم بەکارهێنەرانە بە تەواوەتی دیار نابن. پەیامە کەسییەکانی فەرامۆشکراوان قەدەغە دەکرێن. تکایە سەرنجی ئەوە بدە کە ناتوانیت چاودێران و بەڕێوەبەران فەرامۆش بکەیت.',
	'FOES_UPDATED'				=> 'لیستی فەرامۆشکراوانت بە سەرکەوتوویی نوێکرانەوە.',
	'FOLDER_ADDED'				=> 'بوخچە بەسەرکەوتوویی زیادکرا.',
	'FOLDER_MESSAGE_STATUS'		=> array(
		1	=> '%1$d لە %2$d پەیام پاشەکەوتکرا',
		2	=> '%1$d لە %2$d پەیام پاشەکەوتکرا',
	),
	'FOLDER_NAME_EMPTY'			=> 'پێویستە ناوی بوخچە بنووسیت.',
	'FOLDER_NAME_EXIST'			=> 'بوخچەی <strong>%s</strong> بوونی هەیە.',
	'FOLDER_OPTIONS'			=> 'هەلبژاردنەکانی بوخچە',
	'FOLDER_RENAMED'			=> 'بوخچە بەسەرکەوتویی ناونووس کرایەوە.',
	'FOLDER_REMOVED'			=> 'بوخچە بەسەرکەوتویی سڕایەوە.',
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'بوخچە پڕبووە بە ڕێژەی %3$d%% (%2$d لە %1$s پاشەکەوتکراو)',
		2	=> 'بوخچە پڕبووە بە ڕێژەی %3$d%% (%2$d لە %1$s پاشەکەوتکراو)',
	),
	'FORWARD_PM'				=> 'پ ت ڕەوانە بکە',
	'FORCE_PASSWORD_EXPLAIN'	=> 'پێش ئەوەی بتوانیت بەردەوام بیت لە گەڕان بە ناو مەکۆدا پێویستت بەوەیە تێپەڕەوشەکەت بگۆڕیت.',
	'FRIEND_MESSAGE'			=> 'پەیام لە هاوڕێیەوە',
	'FRIENDS'					=> 'هاوڕێیان',
	'FRIENDS_EXPLAIN'			=> 'هاوڕێیان توانای ئەوەت پێ ئەدەن کە بە خێرایی بگەیت بەو ئەندامانەی کە پەیوەندییان زۆر لەگەڵ ئەکەیت. گەر قاڵبەکە پاڵپشتی پەیوەندیداری کرد هەر پەیامێک لەلایەن هاوڕێیەکەوە بنووسرێت ڕەنگ دەکرێت.',
	'FRIENDS_OFFLINE'			=> 'سەرهێل',
	'FRIENDS_ONLINE'			=> 'سەرهێل',
	'FRIENDS_UPDATED'			=> 'لیستی هاوڕێکانت بە سەرکەوتوویی نوێکرانەوە.',
	'FULL_FOLDER_OPTION_CHANGED'=> 'چالاکی بۆ ئەوەی بە ئەنجام بگەیەندرێت کاتێک بوخچەیەک پڕە بە سەرکەوتوویی گۆڕدرا.',
	'FWD_ORIGINAL_MESSAGE'		=> '-------- پەیامی ڕەسەن --------',
	'FWD_SUBJECT'				=> 'سەردێڕ: %s',
	...
	'MOVE_TO_FOLDER'				=> 'گواستنەوە بۆ ناو بوخچە',
	'MOVE_UP'						=> 'گواستنەوە بۆ سەرەوە',

	'NEW_FOLDER_NAME'				=> 'ناوی بوخچەی نوێ',
	'NEW_PASSWORD'					=> 'تێپەڕەووشەی نوێ',
	'NEW_PASSWORD_CONFIRM_EMPTY'	=> 'تێپەڕەووشەی دڵنیابوونەوەت نەنووسی.',
	'NEW_PASSWORD_ERROR'			=> 'ئەو تێپەڕەوشانەی نووسیوتن وەک یەک نین.',
	...
	'NO_ACTION_MODE'				=> 'هیچ چالاکییەکی پەیام دیاریی نەکراوە.',
	'NO_AUTHOR'						=> 'هیچ نووسەرێک دیاریی نەکراوە بۆ ئەم پەیامە.',
	'NO_AVATAR'						=> 'وێنۆچکە دیاریی نەکراوە',
	'NO_AVATAR_CATEGORY'			=> 'هیچ',
